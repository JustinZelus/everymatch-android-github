...
public class OverScrollView extends FrameLayout implements View.OnTouchListener
{
    ...
    private void initScrollView()
    {
        ...
        post(new Runnable() {
            public void run() {
                maxScroll = child.getPaddingBottom();
    ...
    public boolean onTouchEvent(MotionEvent ev)
    {
        ...
        switch (action & MotionEvent.ACTION_MASK)
        {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mIsBeingDragged)
                {
                    EMLog.i(TAG,"ScrollY = " + getScrollY());
                    EMLog.i(TAG,"TranslationY = " + getTranslationY());
                    ...
                    EMLog.i(TAG,"result = " + (maxScroll - getScrollY() - deltaY));

                    if (maxScroll - getScrollY() - deltaY <= maxScrollDelta){
                        scrollBy(0, nextDelta);
                    }
                }
                break;
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged && !wasOverScroll)
                {
    ...
    public void setMaxOverScrollDelta(int maxScrollDelta) {
