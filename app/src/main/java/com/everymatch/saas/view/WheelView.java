...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        tv.setPadding(Utils.dpToPx(5), 0, Utils.dpToPx(5), 0);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(DataStore.getInstance().getIntColor(EMColor.PRIMARY));
            } else {
                itemView.setTextColor(DataStore.getInstance().getIntColor(EMColor.MOON));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(DataStore.getInstance().getIntColor(EMColor.MOON));
